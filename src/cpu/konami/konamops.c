...
static INLINE void sty_im( void )
{
	CLR_NZV;
	SET_NZ16(Y);
	IMM16;
...
static INLINE void stu_im( void )
{
	CLR_NZV;
	SET_NZ16(U);
    IMM16;
...
static INLINE void setline_im( void )
{
	UINT8 t;
	IMMBYTE(t);
...
static INLINE void setline_ix( void )
{
	UINT8 t;
	t = RM(EA);
...
static INLINE void setline_di( void )
{
	UINT8 t;
	DIRBYTE(t);
...
static INLINE void setline_ex( void )
{
	UINT8 t;
	EXTBYTE(t);
...
/* CLRW indexed -0100 */
static INLINE void clrw_ix( void )
{
	PAIR t;
	t.d = 0;
	WM16(EAD,&t);
...
/* CLRW direct -0100 */
static INLINE void clrw_di( void )
{
	PAIR t;
	t.d = 0;
	DIRECT;
...
/* CLRW extended -0100 */
static INLINE void clrw_ex( void )
{
	PAIR t;
	t.d = 0;
	EXTENDED;
...
/* DECB,JNZ relative ----- */
static INLINE void decbjnz( void )
{
	--B;
	CLR_NZV;
	SET_FLAGS8D(B);
...
/* DECX,JNZ relative ----- */
static INLINE void decxjnz( void )
{
	--X;
	CLR_NZV;
...
/* INCW direct -***- */
static INLINE void incw_di( void )
{
	PAIR t,r;
	DIRWORD(t);
	r = t;
...
/* INCW indexed -***- */
static INLINE void incw_ix( void )
{
	PAIR t,r;
	t.d=RM16(EAD);
	r = t;
...
/* INCW extended -***- */
static INLINE void incw_ex( void )
{
	PAIR t, r;
	EXTWORD(t);
	r = t;
...
/* DECW direct -***- */
static INLINE void decw_di( void )
{
	PAIR t,r;
	DIRWORD(t);
	r = t;
...
/* DECW indexed -***- */
static INLINE void decw_ix( void )
{
	PAIR t, r;
	t.d=RM16(EAD);
	r = t;
...
/* DECW extended -***- */
static INLINE void decw_ex( void )
{
	PAIR t, r;
	EXTWORD(t);
	r = t;
...
/* TSTW direct -**0- */
static INLINE void tstw_di( void )
{
	PAIR t;
	CLR_NZV;
	DIRWORD(t);
...
/* TSTW indexed -**0- */
static INLINE void tstw_ix( void )
{
	PAIR t;
	CLR_NZV;
	t.d=RM16(EAD);
...
/* TSTW extended -**0- */
static INLINE void tstw_ex( void )
{
	PAIR t;
	CLR_NZV;
	EXTWORD(t);
...
/* LSRW direct -0*-* */
static INLINE void lsrw_di( void )
{
	PAIR t;
	DIRWORD(t);
	CLR_NZC;
...
/* LSRW indexed -0*-* */
static INLINE void lsrw_ix( void )
{
	PAIR t;
	t.d=RM16(EAD);
	CLR_NZC;
...
/* LSRW extended -0*-* */
static INLINE void lsrw_ex( void )
{
	PAIR t;
	EXTWORD(t);
	CLR_NZC;
...
/* RORW direct -**-* */
static INLINE void rorw_di( void )
{
	PAIR t,r;
	DIRWORD(t);
	r.d = (CC & CC_C) << 15;
...
/* RORW indexed -**-* */
static INLINE void rorw_ix( void )
{
	PAIR t,r;
	t.d=RM16(EAD);
	r.d = (CC & CC_C) << 15;
...
/* RORW extended -**-* */
static INLINE void rorw_ex( void )
{
	PAIR t,r;
	EXTWORD(t);
	r.d = (CC & CC_C) << 15;
...
/* ASRW direct ?**-* */
static INLINE void asrw_di( void )
{
	PAIR t;
	DIRWORD(t);
	CLR_NZC;
...
/* ASRW extended ?**-* */
static INLINE void asrw_ex( void )
{
	PAIR t;
	EXTWORD(t);
	CLR_NZC;
...
/* ASLW direct ?**** */
static INLINE void aslw_di( void )
{
	PAIR t,r;
	DIRWORD(t);
	r.d = t.d << 1;
...
/* ASLW indexed ?**** */
static INLINE void aslw_ix( void )
{
	PAIR t,r;
	t.d=RM16(EAD);
	r.d = t.d << 1;
...
/* ASLW extended ?**** */
static INLINE void aslw_ex( void )
{
	PAIR t,r;
	EXTWORD(t);
	r.d = t.d << 1;
...
/* ROLW direct -**** */
static INLINE void rolw_di( void )
{
	PAIR t,r;
	DIRWORD(t);
	r.d = (CC & CC_C) | (t.d << 1);
...
/* ROLW indexed -**** */
static INLINE void rolw_ix( void )
{
	PAIR t,r;
	t.d=RM16(EAD);
	r.d = (CC & CC_C) | (t.d << 1);
...
/* ROLW extended -**** */
static INLINE void rolw_ex( void )
{
	PAIR t,r;
	EXTWORD(t);
	r.d = (CC & CC_C) | (t.d << 1);
...
/* NEGW direct ?**** */
static INLINE void negw_di( void )
{
	PAIR r,t;
	DIRWORD(t);
	r.d = -t.d;
...
/* NEGW indexed ?**** */
static INLINE void negw_ix( void )
{
	PAIR r,t;
	t.d=RM16(EAD);
	r.d = -t.d;
...
/* NEGW extended ?**** */
static INLINE void negw_ex( void )
{
	PAIR r,t;
	EXTWORD(t);
	r.d = -t.d;
...
/* LSRD direct -0*-* */
static INLINE void lsrd_di( void )
{
	UINT8 t;
...
/* RORD direct -**-* */
static INLINE void rord_di( void )
{
	UINT16 r;
	UINT8  t;
...
/* ASRD direct ?**-* */
static INLINE void asrd_di( void )
{
	UINT8 t;
...
/* ASLD direct ?**** */
static INLINE void asld_di( void )
{
	UINT32	r;
	UINT8	t;
...
/* ROLD direct -**-* */
static INLINE void rold_di( void )
{
	UINT16 r;
	UINT8  t;
...
/* LSRD indexed -0*-* */
static INLINE void lsrd_ix( void )
{
	UINT8 t;
...
/* RORD indexed -**-* */
static INLINE void rord_ix( void )
{
	UINT16 r;
	UINT8  t;
...
/* ASRD indexed ?**-* */
static INLINE void asrd_ix( void )
{
	UINT8 t;
...
/* ASLD indexed ?**** */
static INLINE void asld_ix( void )
{
	UINT32	r;
	UINT8	t;
...
/* ROLD indexed -**-* */
static INLINE void rold_ix( void )
{
	UINT16 r;
	UINT8  t;
...
/* LSRD extended -0*-* */
static INLINE void lsrd_ex( void )
{
	UINT8 t;
...
/* RORD extended -**-* */
static INLINE void rord_ex( void )
{
	UINT16 r;
	UINT8  t;
...
/* ASRD extended ?**-* */
static INLINE void asrd_ex( void )
{
	UINT8 t;
...
/* ASLD extended ?**** */
static INLINE void asld_ex( void )
{
	UINT32	r;
	UINT8	t;
...
/* ROLD extended -**-* */
static INLINE void rold_ex( void )
{
	UINT16 r;
	UINT8  t;
...
static INLINE void opcode2( void )
{
