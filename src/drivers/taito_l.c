#include "../vidhrdw/taito_l.c"
#include "../sndhrdw/taitosnd.c"
/*
  Taito L-System
...
static void machine_init(void)
{
	...
	taitol_rambanks = (unsigned char*)malloc(0x1000*12);
	palette_ram = (unsigned char*)malloc(0x1000);
	empty_ram = (unsigned char*)malloc(0x1000);
